...
This repository lets you **generate LLM responses** and **evaluate them with different guardrails (supported with [mozilla.ai's any_guardrail](https://github.com/mozilla-ai/any-guardrail))
** in batch.
